...
from mflix.settings import DevConfig
...
def migrate():
    ...
    host = DevConfig.MFLIX_DB_URI

    # don't update this information
    MFLIX_DB_NAME = DevConfig.MFLIX_NS
    ...
    click.echo('{} documents to migrate.'.format(len(movies_to_migrate)))
